...
//             <div className="bg-white text-gray-800 flex items-center justify-center min-h-screen flex-col font-['Inter',_sans-serif]">
//                 <h1 className="mt-[7%] mb-[5%] text-5xl">Contact Us</h1>
//                 <div className="container mx-auto max-w-6xl p-4">
//                     <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
//                         {/* Left Column: Info */}
//                         <div className="flex flex-col space-y-8">
//                             <div>
//                                 <h1 className="text-5xl font-extrabold text-black mt-2 leading-tight">
//                                     HAVE QUESTIONS?
//                                     <br />
//                                     GET IN TOUCH!
//                                 </h1>
...
//                                         </svg>
//                                     </div>
//                                     <span className="text-gray-700">fraemivision@gmail.com</span>
//                                 </div>
//                             </div>
//                         </div>
...
//                                             strokeLinecap="round"
//                                             strokeLinejoin="round"
//                                             className="form-icon text-gray-400"
//                                         >
...
//                                         height="22"
//                                         viewBox="0 0 48 48"
//                                         className="form-icon text-gray-400 mt-2 flex-shrink-0"
//                                     >
...
//                                     <button
//                                         type="submit"
//                                         className="bg-yellow-500 text-black font-semibold py-3 px-5 rounded-md hover:bg-yellow-600 transition-all flex items-center justify-center space-x-2"
//                                     >
//                                         <svg
//                                             xmlns="http://www.w3.org/2000/svg"
//                                             height="22"
...
export default function ContactUs() {
    ...
    return (
        <>
            <Header isScrolled={isScrolled} />
            <div className="bg-background text-foreground flex items-center justify-center min-h-screen flex-col font-['Inter',_sans-serif]">
