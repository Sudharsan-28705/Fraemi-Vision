...
//                         <Logo />
//                         <a href="#" className="text-white text-3xl font-bold ml-3">Fraemi Vision</a>
//                     </a>
//                     <p className="mt-4 max-w-md text-gray-400">
//                         We don't just capture vision; we build its legacy in every frame.
//                     </p>

//                     <div><div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
...
//                 {/* Middle Section: Navigation and Listen On */}
